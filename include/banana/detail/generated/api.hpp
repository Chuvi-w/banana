...
struct send_animation_args_t {
    ...
    optional_t<boolean_t>                                                                                            protect_content;        // Protects the contents of the sent message from forwarding and saving
    optional_t<reply_parameters_t>                                                                                   reply_parameters;       // Description of the message to reply to
    optional_t<variant_t<inline_keyboard_markup_t, reply_keyboard_markup_t, reply_keyboard_remove_t, force_reply_t>> reply_markup;           // Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove a reply keyboard or to force a reply from the user. Not supported for messages sent on behalf of a business account
};
 ...
 * @param args__protect_content Protects the contents of the sent message from forwarding and saving
 * @param args__reply_parameters Description of the message to reply to
 * @param args__reply_markup Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove a reply keyboard or to force a reply from the user. Not supported for messages sent on behalf of a business account
 */
template <class Agent>
...
struct send_game_args_t {
    ...
    optional_t<boolean_t>                protect_content;        // Protects the contents of the sent message from forwarding and saving
    optional_t<reply_parameters_t>       reply_parameters;       // Description of the message to reply to
    optional_t<inline_keyboard_markup_t> reply_markup;           // A JSON-serialized object for an inline keyboard. If empty, one 'Play game_title' button will be shown. If not empty, the first button must launch the game. Not supported for messages sent on behalf of a business account.
};
 ...
 * @param args__protect_content Protects the contents of the sent message from forwarding and saving
 * @param args__reply_parameters Description of the message to reply to
 * @param args__reply_markup A JSON-serialized object for an inline keyboard. If empty, one 'Play game_title' button will be shown. If not empty, the first button must launch the game. Not supported for messages sent on behalf of a business account.
 */
template <class Agent>
 ...
 * @param args__protect_content Protects the contents of the sent message from forwarding and saving
 * @param args__reply_parameters Description of the message to reply to
 * @param args__reply_markup Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove reply keyboard or to force a reply from the user. Not supported for messages sent on behalf of a business account.
 */
template <class Agent>
